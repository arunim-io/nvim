...
gitsigns.setup({
  on_attach = function(bufnr)
    ...
    map('n', '<leader>ggbb', function() gitsigns.blame_line { full = true } end, "[B]lame current changes")
    ...
    map('n', '<leader>ggD', function() gitsigns.diffthis('~') end, "[D]iff current git repo")
